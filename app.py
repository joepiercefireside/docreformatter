...
AI_API_URL = os.environ.get('AI_API_URL', 'https://api.example.com/v1/completions')
...
def call_ai_api(content):
    ...
    prompt = f"""
    Analyze the following medical document content and categorize it into sections matching this output format:
